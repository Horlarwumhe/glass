...
def url_for_parser(parser):
    ...
    view_kwargs = {}
    if not args_list:
        raise TemplateSyntaxError("url_for requires at least one argument", token)
    ...
    for args in args_list:
        try:
            ...
            raise TemplateSyntaxError("malformed argumentin url_for tag", token)
